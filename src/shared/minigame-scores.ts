...
export const SCORE_GAMES = {
  ...
  // 3,345 points of breakable bricks across five fixed stages + 1,500 maximum life bonuses = 4,845, rounded up to 100.
  "keeper-breakout": { label: "골키퍼 벽돌깨기", unit: "점", order: "desc", min: 1, max: 4_900 },

...
const doormomoLyricTiming: readonly LyricCue[] = [
  { startSeconds: 9.27, endSeconds: 11.51, text: "Baila para mí" },
  { startSeconds: 11.51, endSeconds: 12.73, text: "Baila para mí" },
  { startSeconds: 12.73, endSeconds: 13.88, text: "You got me, papi" },
  { startSeconds: 13.88, endSeconds: 15.78, text: "Baila para mí" },
  { startSeconds: 15.78, endSeconds: 18.41, text: "저기 불어오는 바닷바람이" },
  { startSeconds: 18.41, endSeconds: 21.26, text: "파도를 만들어 춤추게 하듯" },
  { startSeconds: 21.26, endSeconds: 22.46, text: "You got me dancing" },
  { startSeconds: 22.46, endSeconds: 23.59, text: "Baila para mí" },
  { startSeconds: 23.59, endSeconds: 25, text: "Give it to me, papi" },
  { startSeconds: 27.53, endSeconds: 29.87, text: "춤을 춰 춤을 춰" },
  { startSeconds: 29.87, endSeconds: 32.1, text: "Dancing like no mañana" },
  { startSeconds: 32.1, endSeconds: 34.39, text: "Summer time, summer time" },
  { startSeconds: 34.39, endSeconds: 36.68, text: "기집애들 이뻐" },
  {
    startSeconds: 36.68,
    endSeconds: 38.99,
    text: "Pop the bottle up, face down",
  },
  { startSeconds: 38.99, endSeconds: 41.26, text: "너와 난 조금 바뻐" },
  {
    startSeconds: 41.26,
    endSeconds: 43.52,
    text: "Keep the base up, face down",
  },
  { startSeconds: 43.52, endSeconds: 45.65, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 45.85, endSeconds: 48.12, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 48.12, endSeconds: 50.4, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 50.4, endSeconds: 52.68, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 52.68, endSeconds: 54.97, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 54.97, endSeconds: 57.27, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 57.27, endSeconds: 59.55, text: "부딪혀 나의 Bumpa" },
  {
    startSeconds: 59.55,
    endSeconds: 62.47,
    text: "부딪혀 나의 Bumpa, paw, paw, paw",
  },
  {
    startSeconds: 62.47,
    endSeconds: 64.12,
    text: "Paw, paw, paw, paw, paw, paw",
  },
  { startSeconds: 64.12, endSeconds: 67.04, text: "Yeah, yuh, BIBI in hurry" },
  { startSeconds: 67.04, endSeconds: 69.3, text: "오늘이 끝인 듯하지" },
  {
    startSeconds: 69.3,
    endSeconds: 74.1,
    text: "사랑을 나누지 달리 뜨거운 날 할게 없지",
  },
  { startSeconds: 74.1, endSeconds: 75.82, text: "So we dancing like uah" },
  { startSeconds: 75.82, endSeconds: 78.4, text: "음악은 점점 가네 둔탁" },
  { startSeconds: 78.4, endSeconds: 79.56, text: "So you got the move" },
  { startSeconds: 79.56, endSeconds: 80.69, text: "Baby, I got one too" },
  { startSeconds: 80.69, endSeconds: 82.44, text: "나를 위해 움직여 One" },
  { startSeconds: 82.44, endSeconds: 84.69, text: "춤을 춰 춤을 춰" },
  { startSeconds: 84.69, endSeconds: 86.97, text: "Dancing like no mañana" },
  { startSeconds: 86.97, endSeconds: 89.23, text: "Summer time, summer time" },
  { startSeconds: 89.23, endSeconds: 91.58, text: "기집애들 이뻐" },
  {
    startSeconds: 91.58,
    endSeconds: 93.83,
    text: "Pop the bottle up, face down",
  },
  { startSeconds: 93.83, endSeconds: 96.12, text: "너와 난 조금 바뻐" },
  {
    startSeconds: 96.12,
    endSeconds: 98.39,
    text: "Keep the base up, face down",
  },
  { startSeconds: 98.39, endSeconds: 100.5, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 100.7, endSeconds: 102.98, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 102.98, endSeconds: 105.27, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 105.27, endSeconds: 107.54, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 107.54, endSeconds: 109.82, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 109.82, endSeconds: 112.12, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 112.12, endSeconds: 114.4, text: "부딪혀 나의 Bumpa" },
  {
    startSeconds: 114.4,
    endSeconds: 117.28,
    text: "부딪혀 나의 Bumpa, paw, paw, paw",
  ...
  { startSeconds: 121.23, endSeconds: 123.54, text: "Baila para mí" },
  { startSeconds: 123.54, endSeconds: 124.73, text: "Baila para mí" },
  { startSeconds: 124.73, endSeconds: 125.86, text: "You got me, papi" },
  { startSeconds: 125.86, endSeconds: 127.84, text: "Baila para mí" },
  {
    startSeconds: 127.84,
    endSeconds: 130.44,
    text: "저기 불어오는 바닷바람이",
  ...
  { startSeconds: 133.24, endSeconds: 134.42, text: "You got me dancing" },
  { startSeconds: 134.42, endSeconds: 135.59, text: "Baila para mí" },
  { startSeconds: 135.59, endSeconds: 139.58, text: "Give it to me, papi" },
  { startSeconds: 139.58, endSeconds: 141.83, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 141.83, endSeconds: 144.08, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 144.08, endSeconds: 146.39, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 146.39, endSeconds: 148.67, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 148.67, endSeconds: 150.98, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 150.98, endSeconds: 153.24, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 153.24, endSeconds: 155.74, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 155.74, endSeconds: 157.81, text: "한번 더 아니 두번 더" },
  { startSeconds: 157.81, endSeconds: 160.12, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 160.12, endSeconds: 162.42, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 162.42, endSeconds: 164.71, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 164.71, endSeconds: 166.97, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 166.97, endSeconds: 169.26, text: "부딪혀 나의 Bumpa" },
  { startSeconds: 169.26, endSeconds: 171.56, text: "부딪혀 나의 Bumpa" },
  {
    startSeconds: 171.56,
    endSeconds: 174.42,
    text: "부딪혀 나의 Bumpa, paw, paw, paw",

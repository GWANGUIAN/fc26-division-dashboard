...
const ANNOUNCEMENTS: Announcement[] = [
  {
    id: "2026-08-jandy-club-notice",
    date: "2026.08.20",
    body: (
      <>
        우왁굳님이 <strong>잔디동 관련 추가 공지</strong>를 올렸습니다.
        <br />
        8월 26일 1차 합격자 발표 예정이며, 커트라인은{" "}
        <strong>디비전 6부~7부</strong>로 정해질 예정입니다. 7부는 디비전
        랭크 외에도 저격 피해를 막기 위한 1:1 직접 평가, 희망 포지션의
        11대 11 플레이 평가, 방송에서의 열정 평가, 게임 외적인 부분까지
        보는 왁덜식(종합) 평가 등 기존에 공지된 다른 요건들도 함께
        확인합니다. 다만 아직 9부에도 못 간 지원자가 많아 합격 인원이
        축소될 수 있습니다.
        <br />
        AI 연습은 세미프로~프로 단계까지만 추천되며, 월드클래스부터는 AI가
        움직임을 예측해버려 오히려 실력이 줄고 뒤로 돌리기만 하는 습관이
        생길 수 있어 지양하는 게 좋다고 합니다.
        <br />
        수비 강의 보완 사항도 있습니다: A(짧은 패스) 수비 시 상대 몸에
        붙어서 연타로 눌러 어깨싸움을 해줘야 볼을 뺏을 수 있다고 합니다.
        <br />
        저격당해 피해를 봤다고 생각되면 개별적으로 1:1 요청이 가능하며,
        1차 합격 이후에는 11대 11 평가전이 진행됩니다. 이에 맞춰 포지션별
        (센터백·풀백·수비형 미드필더·중앙 미드필더·윙포워드·스트라이커)
        평가 기준 교본 영상도 새로 촬영되었습니다.
      </>
    ),
  },
  {

...
describe("equipment catalog vs scripts/pitch-art-manifest.json", () => {
  ...
  it("lists the same pets as the manifest: 6 common + 12 exclusive, one per character", () => {
...
describe("pets per character", () => {
  it("offers its exclusive pet first, then the six common ones", () => {
...
describe("asset groups", () => {
  it("pets:<id> lists the seven pets a character may wear, wearable sheets are part of core", async () => {

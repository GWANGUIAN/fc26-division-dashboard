...
| [13-locker-inventory-spec.md](13-locker-inventory-spec.md) | **락커룸 인벤토리(캐릭터 꾸미기 + 펫) 사양**: 슬롯 검토, 카탈로그(아이템 16·펫 18), 캐릭터별 저장 스키마, 방향별 합성·앵커, 펫 추적, 창 레이아웃, 테스트 | 인벤토리 구현 |
